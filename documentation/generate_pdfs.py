...
def create_dossier_operationnel_pdf(filename):
    ...
    pricing_data = [
        ...
        [Paragraph("Pack Integration", table_cell_bold), Paragraph("Orientation BRT/Dem Dikk + Guide sante & repertoires + Conciergerie Hotline 7j/7 (1 mois)", table_cell_style), Paragraph("60 000 FCFA", table_cell_bold), Paragraph("90 EUR", table_cell_style)],
